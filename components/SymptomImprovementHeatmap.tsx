             ...
             <div className="flow-root">
                <div className="overflow-x-auto">
                    <table className="min-w-full divide-y divide-slate-200 dark:divide-slate-700">
                        <thead>
                            <tr>
                                <th scope="col" className="py-3.5 pl-4 pr-3 text-left text-sm font-semibold text-slate-900 dark:text-slate-100 sm:pl-0">Symptom</th>
                        ...
                        <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
                            {data.map(({ symptom, 'Group A': groupA, 'Group B': groupB }) => {
                                ...
                                return (
                                    <tr key={symptom}>
                                        <td className="py-4 pl-4 pr-3 text-sm font-medium text-slate-800 dark:text-slate-200 sm:pl-0">{symptom}</td>
